                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?php  echo ADMINBASEURL;?>orders/edit/<?php echo $value1["id"];?>" class="btn btn-primary btn-sm" title="Düzenle"><i class="fa fa-edit"></i></a>
                                                <!--<a href="<?php  echo ADMINBASEURL;?>orders/invoice/<?php echo $value1["id"];?>" data-text="<?php if( $value1["invoice_no"] ){ ?>Daha önce fatura yazılmış. Yeni numara ile yazdırmak istiyor musunuz?<?php }else{ ?>Fatura basılacaktır. Onaylıyor musunuz?<?php } ?>" class="btn btn-fatura btn-dark btn-sm" title="Fatura Yazdır"><i class="fa fa-file-invoice"></i></a>-->
                                                <?php if( $value1["cargo_integration_id"] ){ ?><a href="<?php  echo ADMINBASEURL;?>orders/sendcargo/<?php echo $value1["id"];?>" target="_blank" class="btn btn-brand btn-sendcargo btn-sm" title="Kargo Barkod Yazdır"><i class="fas fa-paper-plane"></i></a><?php } ?>

                                                <a href="<?php  echo ADMINBASEURL;?>orders/invoice/<?php echo $value1["id"];?>" target="_blank" class="btn btn-dark btn-sm" title="Fatura Yazdır"><i class="fa fa-file-invoice"></i></a>
                                                <a href="<?php  echo ADMINBASEURL;?>orders/remove/<?php echo $value1["id"];?>" class="btn btn-danger btn-sm remove" title="Sil"><i class="fa fa-trash-alt"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php } ?>
