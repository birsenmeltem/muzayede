<?php if(!class_exists('view')){exit;}?><div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Sayfa Yönetimi</h3>
        </div>
    </div>
</div>
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <a href="<?php  echo ADMINBASEURL;?>pages/add/<?php echo $yer;?>" class="btn btn-success btn-icon-sm">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value1["update_date"];?></td>
                                    <td><?php echo $value1["name"];?></td>
                                    <td><?php echo $value1["shortdetail"];?></td>
                                    <td><?php echo $value1["viewed"];?></td>
                                    <td><?php echo $value1["status_name"];?></td>
                                    <td><?php echo $value1["rows"];?></td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php  echo ADMINBASEURL;?>pages/edit/<?php echo $value1["id"];?>" class="btn btn-primary btn-sm" title="Düzenle"><i class="fa fa-edit"></i></a>
                                            <a href="<?php  echo ADMINBASEURL;?>pages/remove/<?php echo $value1["id"];?>" class="btn btn-danger btn-sm remove" title="Sil"><i class="fa fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
