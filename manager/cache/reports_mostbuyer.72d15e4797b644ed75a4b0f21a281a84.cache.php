        ...
        <div class="kt-portlet__body">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo numbers( $value1["total"] );?> TL</td>
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-9 text-right">
                            <a href="<?php  echo ADMINBASEURL;?>reports/buyer_print?<?php echo $data["querystring"];?>" target="_blank" class="btn btn-success btn-customer-export"><i class="la la-print"></i> ÇIKTI AL</a>
                        </div>
                    </div>
                </div>
            </div>
