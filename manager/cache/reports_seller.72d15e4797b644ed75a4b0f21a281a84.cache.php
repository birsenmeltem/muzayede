                ...
                <div class="kt-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-9 text-right">
                            <a href="<?php  echo ADMINBASEURL;?>reports/seller_print?<?php echo $data["querystring"];?>" target="_blank" class="btn btn-success btn-customer-export"><i class="la la-print"></i> ÇIKTI AL</a>
                        </div>
                    </div>
                </div>
            </div>
