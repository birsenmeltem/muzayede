<?php if(!class_exists('view')){exit;}?><div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Borçlar</h3>
        </div>
    </div>
</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?php  echo ADMINBASEURL;?>wallets/withdrawal_edit/<?php echo $value1["id"];?>" data-toggle="ajaxModal" class="btn btn-primary btn-sm" title="Düzenle"><i class="fa fa-edit"></i></a>
